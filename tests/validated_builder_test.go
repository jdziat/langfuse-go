//lint:file-ignore SA1019 This file intentionally exercises the deprecated Validated* builder hierarchy to verify it still works for backward compatibility.
