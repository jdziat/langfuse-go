...
// ============================================================================
// Re-exports from pkg/client - Core client types (Pkg-prefixed for advanced use)
// ============================================================================

// Core configuration types from pkg/client.
type (
	// PkgConfig is the configuration struct from pkg/client.
	PkgConfig = pkgclient.Config
	// PkgConfigOption is the functional option type from pkg/client.
	PkgConfigOption = pkgclient.ConfigOption
	// PkgBatchResult contains information about a flushed batch.
	PkgBatchResult = pkgclient.BatchResult
	// PkgHealthStatus represents the health status response.
	PkgHealthStatus = pkgclient.HealthStatus
)

// Lifecycle types from pkg/client.
type (
	// PkgClientState represents the current state of the client lifecycle.
	PkgClientState = pkgclient.ClientState
	// PkgLifecycleManager handles client lifecycle with leak prevention.
	PkgLifecycleManager = pkgclient.LifecycleManager
	// PkgLifecycleConfig configures the lifecycle manager.
	PkgLifecycleConfig = pkgclient.LifecycleConfig
	// PkgLifecycleStats contains lifecycle statistics.
	PkgLifecycleStats = pkgclient.LifecycleStats
)

// Ingestion types from pkg/client.
type (
	// PkgClientIngestionEvent represents a single event in a batch.
	PkgClientIngestionEvent = pkgclient.IngestionEvent
	// PkgClientIngestionRequest represents a batch ingestion request.
	PkgClientIngestionRequest = pkgclient.IngestionRequest
	// PkgTime is a time.Time that marshals to RFC3339 format.
	PkgTime = pkgclient.Time
)

// ID generation types from pkg/client.
type (
	// PkgIDStats contains statistics about ID generation.
	PkgIDStats = pkgclient.IDStats
	// PkgClientIDGenerator generates unique IDs with configurable failure handling.
	PkgClientIDGenerator = pkgclient.IDGenerator
	// PkgClientIDGeneratorConfig configures the ID generator.
	PkgClientIDGeneratorConfig = pkgclient.IDGeneratorConfig
)

// Client state constants from pkg/client.
const (
	PkgClientStateActive       = pkgclient.ClientStateActive
	PkgClientStateShuttingDown = pkgclient.ClientStateShuttingDown
	PkgClientStateClosed       = pkgclient.ClientStateClosed
)

// Constructor functions from pkg/client.
var (
	// PkgNewLifecycleManager creates a new lifecycle manager.
	PkgNewLifecycleManager = pkgclient.NewLifecycleManager
	// PkgNow returns the current time as a Time.
	PkgNow = pkgclient.Now
	// PkgWithRequestID returns a context with the given request ID.
	PkgWithRequestID = pkgclient.WithRequestID
)
...
// ============================================================================
// Re-exports from pkg/errors (Pkg-prefixed for advanced use)
// ============================================================================
...
// ============================================================================
// Re-exports from pkg/http (Pkg-prefixed for advanced use)
// ============================================================================
...
// ============================================================================
// Re-exports from pkg/ingestion (Pkg-prefixed for advanced use)
// ============================================================================
