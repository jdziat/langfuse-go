...
// ============================================================================
// Validation Types and Functions - Re-exported from pkg/builders
// ============================================================================

// ValidationMode controls how validation errors are handled.
// Re-exported from pkg/builders.
type ValidationMode = builders.ValidationMode

// ValidationMode constants.
const (
	ValidationModeDeferred  = builders.ValidationModeDeferred
	ValidationModeImmediate = builders.ValidationModeImmediate
)

// Validator provides validation methods for builder types.
// Re-exported from pkg/builders.
type Validator = builders.Validator

// Validation functions - Re-exported from pkg/builders.
var (
	ValidateID         = builders.ValidateID
	ValidateIDFormat   = builders.ValidateIDFormat
	ValidateName       = builders.ValidateName
	ValidateRequired   = builders.ValidateRequired
	ValidatePositive   = builders.ValidatePositive
	ValidateRange      = builders.ValidateRange
	ValidateMetadata   = builders.ValidateMetadata
	ValidateTags       = builders.ValidateTags
	ValidateLevel      = builders.ValidateLevel
	ValidateScoreValue = builders.ValidateScoreValue
	ValidateDataType   = builders.ValidateDataType
)

// Validation constants - Re-exported from pkg/builders.
const (
	MaxNameLength = builders.MaxNameLength
	MaxTagLength  = builders.MaxTagLength
